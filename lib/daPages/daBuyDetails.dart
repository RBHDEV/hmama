...
class daBuyDetails extends StatefulWidget {
  final int data;
  const daBuyDetails({super.key, required this.data});

  @override
  State<daBuyDetails> createState() => _daBuyDetailsState();
}

class _daBuyDetailsState extends State<daBuyDetails> {
  @override
                  ...
                  child: Column(
                    ...
                    children: [
                      Row(
                        ...
                        children: [
                          Text(
                            simpleBuyList[widget.data].name,
                            style: ArabicTextStyle(
                                arabicFont: ArabicFont.avenirArabic,
                                fontSize: 30),
                          ),
                          Text(
                            simpleBuyList[widget.data].price,
                            style: ArabicTextStyle(
                                arabicFont: ArabicFont.avenirArabic,
                                fontSize: 30,
                                color: daSecond,
